...
import logging
import argparse
from module import Preprocessor_transformer, Trainer, Predictor
...
if __name__ == "__main__":
    ...
    with open(args.config, 'r') as config_file:
        try:
            ...
            preprocessor = Preprocessor_transformer(config['preprocessing'], logger)
            ...
            if config['training']['model_name'] == 'transformer': #临时变量，有指针指向但不写入
